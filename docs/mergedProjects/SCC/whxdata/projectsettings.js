...
rh = window.rh;
model = rh.model;
var defaultTopic = "de/General/02_Change_History.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("de/General/02_Change_History.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '4c3f114a-8e3c-40a7-b2b9-a8d9b8970bda' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Sapient Cloud Connector");
