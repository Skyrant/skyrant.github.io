...
rh = window.rh;
model = rh.model;
var defaultTopic = "de/General/Change_History.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("de/General/Change_History.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', 'd731468d-8869-4d25-a192-ee39c4c07b08' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Sapient Beispiele");
