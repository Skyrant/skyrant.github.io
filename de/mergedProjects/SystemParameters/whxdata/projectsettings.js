...
rh = window.rh;
model = rh.model;
var defaultTopic = "de/01_General/SysDoc.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("de/01_General/SysDoc.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', 'b9cb67ad-394d-484b-8cde-83fd2dc5d162' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Systemparameter");
