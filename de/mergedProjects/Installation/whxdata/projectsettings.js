...
rh = window.rh;
model = rh.model;
var defaultTopic = "de/Sys_Inst/General/Change_History.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("de/Sys_Inst/General/Change_History.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '2ea06991-2ffb-4db6-a093-c16f26d44fa7' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Installationsanleitungen");
model.publish(rh.consts('PDF_FILE_NAME'), "");
model.publish(rh.consts('MAX_SEARCH_RESULTS'), "20");
model.publish(rh.consts('KEY_SKIN_FOLDER_NAME'), "Azure_Blue_adj");
