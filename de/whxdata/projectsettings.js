...
rh = window.rh;
model = rh.model;
var defaultTopic = "de/SysDoc.htm";
rh._.exports(defaultTopic);
rh.consts('DEFAULT_TOPIC', encodeURI("de/SysDoc.htm"));
rh.consts('HOME_FILEPATH', encodeURI('index.htm'));
rh.consts('START_FILEPATH', encodeURI('index.htm'));
rh.consts('HELP_ID', '4754f456-2e7f-463f-bb46-5687f511427c' || 'preview');
...
model.publish(rh.consts('KEY_HEADER_TITLE'), "Legato Sapient Systemhilfe");
